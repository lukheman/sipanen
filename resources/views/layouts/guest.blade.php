...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link @if (request()->routeIs('landing')) active @endif"
    ...
    <footer class="py-3 text-center mt-5">
        <small>&copy; {{ date('Y') }} Dinas Perkebunan Dan Peternakan Kabupatan Kolaka. Semua Hak
            Dilindungi.</small>
    </footer>
