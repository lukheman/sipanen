            ...
            <div class="card-body">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="avatar avatar-2xl">
                        <img src="{{ $form->photo ? asset('storage/' . $form->photo) : asset('assets/compiled/jpg/1.jpg') }}"
                            alt="">
                    </div>
                    <div class="mt-2">
            ...
            <div class="card-body">
                <form wire:submit="save">
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="form.nama_petugas" type="text" id="nama_petugas" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="form.jabatan" type="text" id="jabatan" class="form-control"
                            placeholder="Jabatan">
                        @error('form.jabatan')
                            <small class="d-block mt-1 text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <small class="d-block mt-1 text-danger">Anda tidak bisa mengubah kecamatan tempat Anda bertugas,
                            silahkan hubungi admin</small>
                    </div>
