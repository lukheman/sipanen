                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input wire:model="form.jabatan" type="text" class="form-control" id="telepon" placeholder="Masukkan nomor petugas" @if ($currentState === \App\Enums\State::SHOW) disabled @endif>
                                @error('form.jabatan')
                                    <small class="d-block mt-1 text-danger">{{ $message }}</small>
                                @enderror
                            </div>
